...
public class SpecificationTemplate {
    ...
    //Vincula uma pesquisa de determinado id com os filtros do specification
    ...
    public static Specification<LessonModel> lessonModuleId(final UUID moduleId) {
        return (root, query, cb) -> {
            ...
            Expression<Collection<LessonModel>> modulesLesons = module.get("lessons");
            return cb.and(cb.equal(module.get("moduleId"), moduleId), cb.isMember(lesson, modulesLesons));
        };
    }
